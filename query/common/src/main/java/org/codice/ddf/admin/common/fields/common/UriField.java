...
public class UriField extends StringField {
  ...
  public static final String URI_FIELD_DEFAULT_FIELD_NAME = "uri";

  public static final String URI_FIELD_FIELD_TYPE_NAME = "URI";
  ...
  public UriField() {
    this(URI_FIELD_DEFAULT_FIELD_NAME);
  }

  public UriField(String fieldName) {
    super(fieldName, URI_FIELD_FIELD_TYPE_NAME, URI_FIELD_DESCRIPTION);
  }
