...
public class StringField extends BaseScalarField<String> {
  ...
  public static final String STRING_FIELD_DEFAULT_FIELD_NAME = "string";
  ...
  public StringField() {
    this(STRING_FIELD_DEFAULT_FIELD_NAME);
  }
  ...
  public static class ListImpl extends BaseListField<StringField> {
    ...
    public static final String STRING_FIELD_DEFAULT_FIELD_NAME = "strings";
