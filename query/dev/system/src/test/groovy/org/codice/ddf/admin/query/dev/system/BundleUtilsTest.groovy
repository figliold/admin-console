...
class BundleUtilsTest extends Specification {
    ...
    Map<Bundle, Map<String, Bundle>> bundleToPkgDepMap = new HashMap<>()
    List<Bundle> allMockBundles = []
    Map<Bundle, MockBlueprintContainer> allBlueprintContainers = new HashMap<>()
    Map<String, ServiceReference> allServiceRefs = new HashMap<>()
    Map<ServiceReference, Object> allServices = new HashMap<>()
    Map<Bundle, List<ServiceReference>> bundleToRegisteredServices = new HashMap<>()
